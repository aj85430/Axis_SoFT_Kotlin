    ...
    fun executeMySQLQuery() {
        ...
        try {
           ...
           // var b=stmt!!.execute("create database Library")
            ...
            stmt.executeUpdate("CREATE TABLE USERS (UserId INT NOT NULL AUTO_INCREMENT PRIMARY KEY, UserName VARCHAR(50), Password VARCHAR(50))");
            stmt.executeUpdate("ALTER TABLE USERS AUTO_INCREMENT=101")
            stmt.executeUpdate("INSERT INTO USERS(Username, Password) VALUES('Aman','aman')");
