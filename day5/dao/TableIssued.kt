 ...
 */
object MySQLDatabaseExampleKotlin2 {
    ...
    fun executeMySQLQuery() {
        ...
        try {
            ...
            stmt.executeUpdate("CREATE TABLE ISSUED(IssueId INT NOT NULL AUTO_INCREMENT PRIMARY KEY, UserId INT, BookId INT, ISSUED_DATE DATE, RETURN_DATE DATE, PERIOD INT, FINE INT)");
